            ...
            <div className="mt-12 flex flex-wrap gap-8 z-10">
               ...
               <div className="flex items-center space-x-3">
                ...
                <div className="flex-1 flex justify-end items-end space-x-3">
                   <button 
                      onClick={() => handleAction("Sync ERP", () => alert("Strategic state successfully synchronized with Central ERP Core."))}
                   ...
                   <button 
                      onClick={() => handleAction("Export Matrix", () => alert("Executive Insight Report generated. Downloading Strategic PDF matrix..."))}
